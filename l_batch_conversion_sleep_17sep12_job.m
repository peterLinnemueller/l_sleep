...
matlabbatch{1}.spm.meeg.convert.continuous.read.readall = 1;
matlabbatch{1}.spm.meeg.convert.channels.chanall = 1;
matlabbatch{1}.spm.meeg.convert.outfile = '';
matlabbatch{1}.spm.meeg.convert.datatype = 'float32-le';

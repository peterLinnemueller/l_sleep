...
%% choose EEG channels
indAllEEG=find(strcmp(D.chantype,'EEG')); % find indices of EEG-type channels
...
%% set all but sleepEEG channels to type 'Other'
...
E=D.chantype(1:length(channelTypesOrig),channelTypesNew); % leo: E is new EEG-object (all other chantypes='Other')
...
%% => Leo: tuts irgendwie nicht. E hat noch alle infos über channelpositions, etc.??? 

...
for crun = 1:nrun
    ...
    inputs{2, crun} = cellstr([rootDir,folderList{crun}(2:end)]); % M/EEG Conversion: File Name - cfg_files
    inputs{3, crun} = cellstr(rootDir); % Change Directory: Directory - cfg_files
end
spm('defaults', 'EEG');
spm_jobman('initcfg');

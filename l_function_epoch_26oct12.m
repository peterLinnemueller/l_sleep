...
BC           = S.BC;
 ...
 cd(workDir)
  ...
  tic
  ret = l_function_create_trialdef_26oct12(S);  
  toc
...
epochinfo=load(spm_select('FPList',workDir,['^trials_spindels_psi',num2str(PSI_START_MS),'-',num2str(PSI_END_MS),'_',sOVERLAP,'_',num2str(D.fsample),'Hz_',CONDITION,'.mat$'])); 
